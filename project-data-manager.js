...
const ProjectDataManager = {
     ...
     */
    getProjectStatusDetails(project) {
        const daysUntilDeadline = this.getDaysUntilDeadline(project.deadline);
        ...
        // Determine deadline class and text
        let deadlineClass = '';
        let deadlineText = '';
    ...
    loadSelectedProject() {
        ...
        if (projectData) {
            try {
                ...
                if (project.deadline && typeof project.deadline === 'string') {
